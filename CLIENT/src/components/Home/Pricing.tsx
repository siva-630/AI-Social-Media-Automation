            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-gray-900">
                        ...
                        <br />
                        <span className="text-violet-400 italic">of growth</span>
                    </h2>
                        ...
                        <div key={plan.name} className={`rounded-2xl border p-7 flex flex-col gap-6 relative h-full ${plan.highlight ? "bg-violet-500 text-white border-violet-400 shadow-2xl shadow-violet-200" : "bg-white text-slate-900 border-slate-200"}`}>
                            ...
                            <div>
                                ...
                                <div className="flex items-end gap-1">
                                    ...
                                    <span className={`text-sm mb-1.5 ${plan.highlight ? "text-violet-200" : "text-slate-400"}`}>{plan.period}</span>
                                </div>
                                <p className={`text-sm mt-2 leading-relaxed ${plan.highlight ? "text-violet-100" : "text-slate-500"}`}>{plan.description}</p>
                            </div>
